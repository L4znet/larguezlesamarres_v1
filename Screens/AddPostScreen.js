    ...
    return (
        <View>
            <KeyboardAwareScrollView>
                ...
                <TextInput style={[styles.form.fullInput, styles.form.input]} onChangeText={(localization) => setLocalization(localization)} placeholderTextColor="#9e9e9e" placeholder="Votre localisation" />
